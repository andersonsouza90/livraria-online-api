...
public class LivroController {
	...
	public ResponseEntity<LivroDto> cadastrar(@RequestBody @Valid LivroDtoForm dto,
	...
	@PutMapping
	public ResponseEntity<LivroDto> atualizar(@RequestBody @Valid AtualizarLivroFormDto dto) {
	...
	@GetMapping("/{id}")
	public ResponseEntity<LivroConsultarDto> consultar(@PathVariable @NotNull Long id) {
		LivroConsultarDto dto = service.consultar(id);
